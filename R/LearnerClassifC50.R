    ...
    initialize = function(id = "classif.C50") {
      ps = ParamSet$new(
        params = list(
          ...
          ParamDbl$new(id = "CF", lower = 0, upper = 1, default = 0.25, tags = c("train", "C5.0Control")),
          ParamInt$new(id = "minCases", lower = 0L, upper = Inf, default = 2L, tags = c("train", "C5.0Control")),
          ParamLgl$new(id = "fuzzyThreshold", default = FALSE, tags = c("train", "C5.0Control")),
          ParamDbl$new(id = "sample", lower = 0, upper = .999, default = 0, tags = c("train", "C5.0Control")),
      ...
      super$initialize(
        ...
        man = "mlr3learners.C50::mlr_learners_classif.C50"
        )
      }
    ),
