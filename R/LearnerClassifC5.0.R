...
LearnerClassifC5.0 <- R6Class("LearnerClassifC5.0",
  ...
  public = list(
    ...
    initialize = function(id = "classif.C5.0") {
      ps <- ParamSet$new(
        params = list(
          ...
          ParamDbl$new(id = "CF", default = 0.25, lower = 0, upper = 1, tags = c("train", "C5.0Control")),
          ParamInt$new(id = "minCases", default = 2L, lower = 0L, upper = Inf, tags = c("train", "C5.0Control")),
          ParamLgl$new(id = "fuzzyThreshold", default = FALSE, tags = c("train", "C5.0Control")),
          ParamDbl$new(id = "sample", default = 0, lower = 0, upper = .999, tags = c("train", "C5.0Control")),
